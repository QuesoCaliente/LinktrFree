...
export const profile = {
	...
	name: 'Queso Caliente',
	bio: 'Soy Ingeniero en Informática, apasionado por la Inteligencia Artificial, la tecnología y los videojuegos. Sígueme en Twitch e Instagram',
	links: [
		...
		{ label: 'Visita mi blog', detail: 'Artículos sobre tecnología e IA', href: 'https://www.quesocaliente.dev/blog', icon: 'book', external: true },
